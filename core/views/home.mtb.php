...
?>
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <div class="block-heading">
                    <h2 class="text-info">For Developers</h2>
                </div>
                <div class="block-content">
                    <p>
                        If you are a developer and looking to for a job, we are hiring!
                        Search through the job opportunities to find a position that works best for you.
                        We have an open source community for the hobbyists.
                        You can upload and present your new ideas and patches for our platform.
                    </p>
                </div>
                <div class="block-heading">
